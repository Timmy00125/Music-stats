...
def test_get_user_profile_success(mock_get, spotify_api: SpotifyAPI):
...
@patch("app.spotify_api.requests.get")
def test_make_request_get_method(mock_get, spotify_api: SpotifyAPI):
    ...
    result = spotify_api._make_request("/test")
...
def test_check_token_not_expired(spotify_api: SpotifyAPI):
    ...
    spotify_api._check_token()
    assert spotify_api.access_token == original_token


@patch("app.spotify_api.requests.get")
def test_make_request_http_error(mock_get, spotify_api: SpotifyAPI):
    ...
    with pytest.raises(requests.exceptions.HTTPError):
        spotify_api._make_request("/nonexistent")
